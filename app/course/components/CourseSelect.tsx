...
export default function CourseSelect() {
  return (
    <div className="flex flex-col gap-6 mt-6 px-2 w-[220px] h-min">
      <p className="fixed -mt-6 text-xs text-muted-foreground">Courses:</p>
      <div className="flex flex-row gap-2 items-center bg-muted rounded-lg p-4">
        ...
        <span className="font-semibold text-sm">Course Title 1</span>
      </div>
    </div>
  );
}
